...
class MemapParser(object):
    ...
    def generate_table(self, file_desc):
        ...
        for k in self.print_sections:
            subtotal_row.append("{}".format(self.subtotal[k]))
        ...
        output += self.RAM_FORMAT_STR.format(self.mem_summary['static_ram'])
        output += self.ROM_FORMAT_STR.format(self.mem_summary['total_flash'])
